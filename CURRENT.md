...
| --- | --- | --- | --- | --- |
| P1 | [AR-0030](tasks/AR-0030.md): Terminology registry and enforcement | Add reusable canonical-vocabulary declarations and deterministic terminology enforcement. | Rerun the corrected focused and fully confined suites after the cross-policy canonical collision hardening, then stage exact files and complete publication gates. | codex-awq-ar0030-terminology |
