...
| P1 | [AR-0031](tasks/AR-0031.md): Formal-model adapter profile | Add a bounded formal-model execution adapter with truthful evidence output. | Run full coverage and remaining generated, contract, doctor, AWQ, archive, and privacy gates with all scratch and outputs explicitly on the second disk. | codex-awq-ar0031-formal-adapter |
