...
| --- | --- | --- | --- | --- |
| P1 | [AR-0030](tasks/AR-0030.md): Terminology registry and enforcement | Add reusable canonical-vocabulary declarations and deterministic terminology enforcement. | Create and verify the signed DCO follow-up commit, push PR 27 without force, and wait for exact-head CI. | codex-awq-ar0030-terminology |
