...
| P1 | [AR-0031](tasks/AR-0031.md): Formal-model adapter profile | Add a bounded formal-model execution adapter with truthful evidence output. | Confirm remote release branch is absent, non-force push exact clean head, open sanitized release PR, and wait for exact-head required CI without merging or tagging. | codex-awq-ar0031-formal-adapter |
