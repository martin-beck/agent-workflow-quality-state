...
| --- | --- | --- | --- | --- |
| P1 | [AR-0030](tasks/AR-0030.md): Terminology registry and enforcement | Add reusable canonical-vocabulary declarations and deterministic terminology enforcement. | Coordinator independently authenticates exact c1fb70c v0.26.0 candidate from the handed-off byte-identical bundle digests; do not tag or publish until authentication and release gates are accepted. | codex-awq-ar0030-terminology |
