...
| `agent-workflow-quality-promotion` | `feature/consumer-promotion` | `2b3ff6ed8c02` | 8 | behind 0, ahead 0 |
| changed files | - | - | - | `fixtures/conforming/consumer-equivalence.json`, `schemas/consumer-equivalence.schema.json`, `src/awq/checks.py`, `src/awq/cli.py`, `src/awq/commands.py`, `src/awq/promotion.py`, `templates/consumer-equivalence.json`, `tests/test_promotion.py` |
