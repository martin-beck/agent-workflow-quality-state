...
| `agent-workflow-quality-adapter-python` | `feature/python-adapter` | `65c0b9c0f4b1` | 2 | behind 0, ahead 0 |
| changed files | - | - | - | `schemas/adapter-catalog.schema.json`, `src/awq/data/adapter_catalog.json` |
