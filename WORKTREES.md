...
| `agent-workflow-quality-adapter-python` | `feature/python-adapter` | `65c0b9c0f4b1` | 7 | behind 0, ahead 0 |
| changed files | - | - | - | `pyproject.toml`, `scripts/validate_contracts.py`, `src/awq/adapters.py`, `src/awq/cli.py`, `src/awq/commands.py`, `schemas/adapter-catalog.schema.json`, `src/awq/data/adapter_catalog.json` |
