...
| --- | --- | --- | --- | --- |
| P0 | [AR-0052](tasks/AR-0052.md): Bounded TLA+ execution and admission safety | codex-awq-ar0052-tla-admission-20260913 | Prevent Agent Workflow Quality formal jobs from exhausting shared host memory. | Independent exact-head review of 9a1ffbd against base 52018dc; verify helper-only execution, bounded durable queue/recovery arguments, cgroup memory/swap contract, signatures/DCO/privacy, then PR/CI. |
