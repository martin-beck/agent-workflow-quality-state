...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-review-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Inspect configured remotes and exact local refs, then fetch from the pull-request repository only if needed and continue the independent review. |
