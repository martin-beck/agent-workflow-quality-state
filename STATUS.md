...
| --- | --- | --- | --- | --- |
| P0 | [AR-0039](tasks/AR-0039.md): Pinned repository-security adapter family | /root/ar0039_catalog_fix | Add offline repository-security adapters for workflow syntax, security analysis and full introduced-history secret scanning. | Await fresh Verify and Portable workflows for exact head 59b76dcb5a47d2feeb021226f744b7456e8ac287. |
