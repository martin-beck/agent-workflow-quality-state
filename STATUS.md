...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-corrections-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Resolve or dependency-sequence explicit contract-catalog registry evolution for the new test-report contract, then regenerate catalog/baseline/docs/provenance and rerun all exact-head gates. |
