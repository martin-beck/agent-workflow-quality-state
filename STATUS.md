...
| P1 | [AR-0051](tasks/AR-0051.md): Version-coupled v0.33.0 release preparation | Unclaimed | Independent exact-head review accepted; publication gates remain | Publish clean signed DCO PR for f926a74, await exact-head required CI, then merge only after green and run guarded v0.33.0 release/public verification. |
