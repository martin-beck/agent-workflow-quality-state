...
| --- | --- | --- | --- | --- |
| P0 | [AR-0036](tasks/AR-0036.md): Consumer assurance-plan contract | codex-awq-ar0036-assurance-plan-20260911 | Validate that consumers have a complete, owned and evidence-producing assurance plan without replacing their native gates. | Rerun assurance-plan fixture schema/runtime parity, then add generated documentation, complete hostile and observation tests, and integrate the contract catalog without publishing before the reserved v0.34 sequence. |
