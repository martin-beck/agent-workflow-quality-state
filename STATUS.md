...
| P1 | [AR-0044](tasks/AR-0044.md): Cross-ecosystem vulnerability and workspace supply policy | codex-awq-ar0044-cross-supply-20260911 | Generalize advisory evidence and ensure every executed auxiliary dependency graph receives locked supply-chain review. | After AR-0040 v0.31 and AR-0041 v0.32 are released, rebase signed local checkpoint cb8e20a832c8f61dbcad905c16ca0df9856a3a26, integrate the new contract through the shared reviewed additive-baseline mechanism for the dependency-ordered future version, then rerun full distribution and release gates before review. |
