...
| --- | --- | --- | --- | --- |
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-release-correction-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Correct PR #42 migration-preview template from_version to 0.30.0, add or tighten a release-current/predecessor assertion so this cannot recur, regenerate affected fixtures if required, create a new signed DCO head, then rerun independent exact-head review and CI; do not merge 3ba4ba42. |
