...
| Priority | AR | Owner | Summary | Next action |
| --- | --- | --- | --- | --- |
| P1 | [AR-0054](tasks/AR-0054.md): Version-coupled v0.35.0 release follow-up | Unclaimed | Version-coupled v0.35.0 release follow-up for the merged AR-0052 bounded TLA+ admission-safety capability. | Publication owner may publish a clean exact-head PR for 66f125e, obtain exact-head required CI, then merge/release only after independent gates and public verification; preserve AR-0056 planned dependency. |
