...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-review-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Rerun the full suite with the reviewed offline tool prefixes, then complete static, generated-contract, distribution and privacy checks before releasing the blocked review. |
