...
| P1 | [AR-0031](tasks/AR-0031.md): Formal-model adapter profile | codex-awq-ar0031-formal-adapter | Add a bounded formal-model execution adapter with truthful evidence output. | Correct the independently re-downloaded TLA+ Tools v1.8.0 SHA-256 pin, rerun the live atomic installer, then execute full gates. |
