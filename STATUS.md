...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | Unclaimed | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Merge PR #39 only at exact accepted head f01b01e1a60fa0937302a5fd1bd5d79a238c539b, verify exact-main CI, then prepare and authenticate the dependency-ordered v0.31.0 release with production trust policy and fresh public verification before closing AR-0040. |
