...
| --- | --- | --- | --- | --- |
| P1 | [AR-0054](tasks/AR-0054.md): Version-coupled v0.35.0 release follow-up | awq-coordinator-publication | Publication PR #58 open; exact-head matrix green, Verify running | Await PR #58 required Verify run 34818735588 terminal green; then merge exact head, verify post-merge main, build/sign/publish v0.35.0 and complete attestation/public verification. |
