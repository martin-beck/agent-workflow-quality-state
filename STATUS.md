...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-corrections-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Finish focused schema/runtime/release and standalone-installer regressions, then run full static/generated/release gates and publish a signed exact head. |
