...
| P1 | [AR-0041](tasks/AR-0041.md): Execution budgets and process-boundary receipts | codex-awq-ar0041-review-20260911 | Represent enforced, observed, estimated and unavailable execution resources with bounded lifecycle and uncertainty evidence. | Implementation must expand the finite model and known-bad assertions to actually exercise rejected conservation, ordering, descendant and orphan states, alongside the runtime fixes already recorded. |
