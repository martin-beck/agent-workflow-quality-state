...
| --- | --- | --- | --- | --- |
| P1 | [AR-0003](tasks/AR-0003.md): Policy governance and exception lifecycle | codex-awq-ar0003 | Harden weakening detection, exception approval, repository rules and ownership boundaries. | Decompose semantic policy diff, exception expiry, CODEOWNERS and GitHub ruleset enforcement. |
