...
| --- | --- | --- | --- | --- |
| P0 | [AR-0035](tasks/AR-0035.md): Public contract catalog and evolution gate | codex-awq-ar0035-release-20260911 | Prove that every public AWQ contract is registered, versioned, documented and covered by positive, hostile and implementation tests. | Do not merge PR 41. Restrict release-version normalization to the exact intended pinned string-value locations, retain strict semantics for JSON Schema property definitions and non-version shapes, add hostile regressions for both reproduced cases, regenerate the v0.30 baseline, rerun all release/reproducibility gates with the independently provisioned trust-policy digest, then obtain a new independent exact-head review. |
