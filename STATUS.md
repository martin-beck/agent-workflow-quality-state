...
| P1 | [AR-0044](tasks/AR-0044.md): Cross-ecosystem vulnerability and workspace supply policy | codex-awq-ar0044-path-correction-20260911 | Generalize advisory evidence and ensure every executed auxiliary dependency graph receives locked supply-chain review. | Run the new path-parity and cloned-workspace hostile regressions after the narrow dot-segment rejection, then focused 100 percent module coverage, full applicable gates, and a clean signed DCO checkpoint for a different independent reviewer; retain catalog deferral. |
