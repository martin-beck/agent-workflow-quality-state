...
| P1 | [AR-0054](tasks/AR-0054.md): Version-coupled v0.35.0 release follow-up | codex-awq-ar0054-release-20260913 | Version-coupled v0.35.0 release follow-up for the merged AR-0052 bounded TLA+ admission-safety capability. | Claim only after selecting a release worker; start from exact AR-0052 merge fda0517db777b834173253261aca0ba44b28f0f7 and execute the version-coupled v0.35.0 plan. |
