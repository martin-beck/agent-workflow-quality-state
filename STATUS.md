...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-test-reports-20260910 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Create the signed DCO candidate, run reproducible release checks, publish the PR and await exact-head CI. |
| P1 | [AR-0043](tasks/AR-0043.md): Evidence lineage publication and retention lifecycle | codex-awq-ar0043-evidence-lineage-20260910 | Bind evidence and decisions into immutable lineages while separating required gates, optional publication and non-authorizing retention plans. | Regenerate the version-coupled provenance fixture through the repository generator, verify it is stable, then finish formal, contract, doctor and PR-tier gates. |
