...
| Priority | AR | Owner | Summary | Next action |
| --- | --- | --- | --- | --- |
| P0 | [AR-0052](tasks/AR-0052.md): Bounded TLA+ execution and admission safety | Unclaimed | Prevent Agent Workflow Quality formal jobs from exhausting shared host memory. | Independent exact-head review of 06cc73f against base 4a1d026; verify admission semantics, v1 preservation, signatures/DCO/privacy, then PR/CI handoff. |
