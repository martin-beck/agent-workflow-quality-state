...
| --- | --- | --- | --- | --- |
| P1 | [AR-0018](tasks/AR-0018.md): Pinned Rust assurance profile and adapters | codex-awq-ar0018 | Add reviewed Rust formatting, lint, dependency, compatibility and advanced test evidence contracts. | Complete and release the three Rust child ARs, then verify the combined profile acceptance. |
