...
| --- | --- | --- | --- | --- |
| P1 | [AR-0024](tasks/AR-0024.md): Canonical SPDX SBOM and license inventory | codex-awq-ar0024 | Generate deterministic release SBOMs that identify AWQ, build inputs, licenses and artifact relationships. | Implement after AR-0023 fixes the release-manifest and artifact identity contracts. |
