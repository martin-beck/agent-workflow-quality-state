...
| --- | --- | --- | --- | --- |
| P0 | [AR-0052](tasks/AR-0052.md): Bounded TLA+ execution and admission safety | codex-awq-ar0052-tla-admission-20260913 | Prevent Agent Workflow Quality formal jobs from exhausting shared host memory. | Rebase signed checkpoint onto exact current origin/main, rerun focused and applicable gates; full-suite remaining failures require provisioned wrappers and version-aligned venv before review handoff. |
