...
| --- | --- | --- | --- | --- |
| P1 | [AR-0054](tasks/AR-0054.md): Version-coupled v0.35.0 release follow-up | awq-coordinator | Current-main v0.35.0 candidate reconstructed; release gates pending | Run focused/full release gates on exact current-main candidate 6737cb8; then independent review and publication gates. External signer/trust authority remains required for authenticated tag/manifest. |
