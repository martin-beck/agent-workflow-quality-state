...
| P1 | [AR-0044](tasks/AR-0044.md): Cross-ecosystem vulnerability and workspace supply policy | codex-awq-ar0044-cross-supply-20260913 | Generalize advisory evidence and ensure every executed auxiliary dependency graph receives locked supply-chain review. | Rebased onto exact origin/main 1c1bf3b; resolve generated contract-catalog registration and rerun gates. Earlier exit 1 was environment-only: wrapper cwd did not include product root/PYTHONPATH; corrected focused vulnerability suite passes 21 tests. |
