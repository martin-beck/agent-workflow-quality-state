...
| --- | --- | --- | --- | --- |
| P1 | [AR-0030](tasks/AR-0030.md): Terminology registry and enforcement | codex-awq-ar0030-terminology | Add reusable canonical-vocabulary declarations and deterministic terminology enforcement. | Coordinator independently reviews the complete exact-head diff and reruns the full suite with the reviewed second-disk toolchain; merge only after that independent evidence remains green. |
