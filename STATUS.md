...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-corrections-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Rerun focused/full suites with complete pinned adapter PATH, then generated, release, signature, privacy, exact-force-with-lease publication and hosted-CI gates. |
