...
| P1 | [AR-0041](tasks/AR-0041.md): Execution budgets and process-boundary receipts | codex-awq-ar0041-budget-receipts-20260910 | Represent enforced, observed, estimated and unavailable execution resources with bounded lifecycle and uncertainty evidence. | Run adversarial, reliability, self-host, privacy and deterministic release-build gates; inspect the complete diff before the signed publication commit. |
