...
| --- | --- | --- | --- | --- |
| P0 | [AR-0035](tasks/AR-0035.md): Public contract catalog and evolution gate | codex-awq-ar0035-second-review-20260911 | Prove that every public AWQ contract is registered, versioned, documented and covered by positive, hostile and implementation tests. | Implementation must version-gate contract-catalog schema/data requirements at the first release that contains them, add an actual pre-catalog wheel/sdist regression fixture or equivalent faithful historical test, and return a new signed DCO exact head for another independent review. PR #36 must not merge. |
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-test-reports-20260910 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Amend the signed candidate with the standalone installer integration fix, rerun release checks, force-update PR 39 with an exact lease, and await exact-head CI. |
