...
| P1 | [AR-0068](tasks/AR-0068.md): Role-scoped quality profile selection | ar0068-role-profiles | Add a role dimension to awq.json/awq.lock.json so security tasks pull security gates and documentation tasks pull documentation adapters. | Wait for PR #75 exact-head Verify rerun at bc48420317e1092cdb7ac505bccf455bff6a7ddd; merge only after all required checks are green and independent review completes. |
