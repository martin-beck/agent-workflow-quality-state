...
| --- | --- | --- | --- | --- |
| P1 | [AR-0030](tasks/AR-0030.md): Terminology registry and enforcement | codex-awq-ar0030-terminology | Add reusable canonical-vocabulary declarations and deterministic terminology enforcement. | Validate the Markdown closing-fence correction with focused and complete confined gates, then create a signed DCO fix commit and update PR 27. |
