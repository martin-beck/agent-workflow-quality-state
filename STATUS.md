...
| P1 | [AR-0040](tasks/AR-0040.md): Generic structured test-report evidence | codex-awq-ar0040-corrections-20260911 | Provide reusable structured test-report evidence for mixed-language repositories without mistaking file presence for executed tests. | Rerun the exact-head focused and full suites after fixture restoration, then complete generated, static, release, signature, privacy, publication and hosted-CI gates. |
