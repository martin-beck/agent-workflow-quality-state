...
| P1 | [AR-0044](tasks/AR-0044.md): Cross-ecosystem vulnerability and workspace supply policy | codex-awq-ar0044-path-correction-20260911 | Generalize advisory evidence and ensure every executed auxiliary dependency graph receives locked supply-chain review. | A different independent reviewer must inspect exact clean signed DCO checkpoint 88a4f1c70ad9ff33ba6d33c6f5b881deb4e06c4a over fe1db46d48a1250535c48b101e2ee5d4be588987, reproduce direct path aliases and the full cloned-workspace evasion, and verify schema/runtime parity plus focused/full gates. Keep catalog integration deferred until dependency-ordered publication; do not rebase, publish, or merge in review. |
