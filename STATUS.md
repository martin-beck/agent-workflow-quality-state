...
| --- | --- | --- | --- | --- |
| P1 | [AR-0030](tasks/AR-0030.md): Terminology registry and enforcement | codex-awq-ar0030-terminology | Add reusable canonical-vocabulary declarations and deterministic terminology enforcement. | Run two independent clean deterministic v0.26.0 builds from detached exact merge c1fb70c, then source-verify and distribution-inspect each bundle and hand off exact digests; do not tag or publish. |
