...
| --- | --- | --- | --- | --- |
| P0 | [AR-0035](tasks/AR-0035.md): Public contract catalog and evolution gate | codex-awq-ar0035-review-20260910 | Prove that every public AWQ contract is registered, versioned, documented and covered by positive, hostile and implementation tests. | Correct nested semantic compatibility classification and require executable resolution of implementation_conformance, fixture cases and test argv classes; add hostile regressions, republish a signed exact head, then repeat independent review. |
...
| P1 | [AR-0041](tasks/AR-0041.md): Execution budgets and process-boundary receipts | codex-awq-ar0041-budget-receipts-20260910 | Represent enforced, observed, estimated and unavailable execution resources with bounded lifecycle and uncertainty evidence. | Publish the clean signed exact head, wait for every exact-head PR check, then release the claim for independent review without merging. |
