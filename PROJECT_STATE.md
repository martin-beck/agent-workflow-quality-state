...
| --- | --- | --- | --- | --- | --- |
| #62 | `feature/repository-security-adapters@38aa20523de3` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(security): add pinned repository security adapters |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34889454774 | `38aa20523de3` | pull_request | Portable onboarding | in_progress:- |
| 34889454532 | `38aa20523de3` | pull_request | Verify | in_progress:- |
| 34889198695 | `eaa24141ef96` | pull_request | Verify | completed:failure |
