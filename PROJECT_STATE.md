...
| --- | --- | --- | --- | --- | --- |
| #40 | `feature/evidence-lineage-lifecycle@9e9518d077d5` | `main` | BLOCKED | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS: | feat(evidence): add lineage lifecycle contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34771961244 | `9e9518d077d5` | pull_request | Verify | in_progress:- |
| 34771961243 | `9e9518d077d5` | pull_request | Portable onboarding | queued:- |
