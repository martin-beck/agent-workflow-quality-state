...
| --- | --- | --- | --- | --- | --- |
| #40 | `feature/evidence-lineage-lifecycle@f619c2ef9053` | `main` | BLOCKED | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(evidence): add lineage lifecycle contract |
