...
| --- | --- | --- | --- | --- | --- |
| #62 | `feature/repository-security-adapters@3c7c851cf745` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(security): add pinned repository security adapters |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34887622762 | `3c7c851cf745` | pull_request | Portable onboarding | in_progress:- |
| 34887622731 | `3c7c851cf745` | pull_request | Verify | in_progress:- |
