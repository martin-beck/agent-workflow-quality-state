...
| #40 | `feature/evidence-lineage-lifecycle@4e061c35aace` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(evidence): add lineage lifecycle contract |
