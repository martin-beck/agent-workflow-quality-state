...
- Primary worktree head: `b4a7626f3c8861d5bbcdc45d3e90c98afec1995a`

## Open pull requests

| PR | Head | Base | Merge | Checks | Title |
| --- | --- | --- | --- | --- | --- |
| #66 | `feature/ar-0058-interaction-gate@b4a7626f3c88` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat: add typed oracle interaction-gate quality contract |
...
| 35236696372 | `b4a7626f3c88` | pull_request | Portable onboarding | in_progress:- |
