...
| --- | --- | --- | --- | --- | --- |
| #70 | `codex/ar-0063-discussion@269a051df423` | `main` | BLOCKED | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat: add batched discussion quality contract |
| #71 | `codex/ar-0061-oracle-workflow-integration@f7ff9aafdc99` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat: add oracle workflow integration gate |
...
| 35472469377 | `f7ff9aafdc99` | pull_request | Verify | in_progress:- |
...
| 35471831068 | `2970d029e9fb` | pull_request | Verify | completed:failure |
| 35471831036 | `2970d029e9fb` | pull_request | Portable onboarding | completed:success |
