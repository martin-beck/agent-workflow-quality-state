...
| #45 | `feature/assurance-plan-contract@e69d6ae4dc98` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(assurance): add consumer assurance-plan contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34777484609 | `e69d6ae4dc98` | pull_request | Portable onboarding | in_progress:- |
