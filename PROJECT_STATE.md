...
- Local origin/main: `f1c40859e9d10cacbc79100ed136c38bce48cd39`
...
| --- | --- | --- | --- | --- | --- |
| #40 | `feature/evidence-lineage-lifecycle@f619c2ef9053` | `main` | BLOCKED | IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS: | feat(evidence): add lineage lifecycle contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34771610549 | `f619c2ef9053` | pull_request | Portable onboarding | in_progress:- |
| 34771610545 | `f619c2ef9053` | pull_request | Verify | in_progress:- |
...
| 34560321894 | `ec2706285693` | pull_request | Verify | completed:success |
